<stylesheet xmlns="http://www.w3.org/1999/XSL/Transform"
    ...
    <function name="keronic:get-connected-threshold">
        <value-of select="$config_file/config/Topology/ConnectedThreshold"/>
    </function>
    <function name="keronic:get-ls-cable-min-measurement-distance">
         <value-of select="$config_file/config/LSkabel/MinMeasurementDistance"/>
    </function>

    <function name="keronic:get-ls-cable-max-measurement-distance">
         <value-of select="$config_file/config/LSkabel/MaxMeasurementDistance"/>
    </function>

    <function name="keronic:get-ls-mof-max-cable-connection">
         <value-of select="$config_file/config/LSmof/MaxConnectionCount"/>
    </function>

    <function name="keronic:get-ls-mof-min-cable-connection">
         <value-of select="$config_file/config/LSmof/MinConnectionCount"/>
    </function>

    <function name= "keronic:get-ls-cable-min-measurement-angle">
        <value-of select="$config_file/config/LSkabel/MinMeasurementAngle"/>
    </function>

    <function name= "keronic:get-ms-cable-connections-end">
        <value-of select="$config_file/config/MSkabel/ConnectionCountEnd"/>
    </function>
      <function name= "keronic:get-ms-cable-connections-start">
        <value-of select="$config_file/config/MSkabel/ConnectionCountStart"/>
    </function>

    <function name= "keronic:get-statuses-without-empty-ends" as="xs:string*">
        <sequence select="$config_file/config/MSkabel/StatusWithoutEmptyEnds/Status"/>
    </function>

    <function name= "keronic:ls-mof-spanning-ls-cable-status-check" as="xs:string*">
        <sequence select="$config_file/config/LSmof/LSkabelSpanningCheck/Status"/>
    </function>

    <function name= "keronic:ls-mof-phase-ls-cable-status-check" as="xs:string*">
        <sequence select="$config_file/config/LSmof/LSkabelPhaseCheck/Status"/>
    </function>

    <function name= "keronic:ls-mof-phase-ls-cable-l1-indication" as="xs:string*">
        <sequence select="$config_file/config/LSmof/LSkabelPhaseCheck/L1"/>
    </function>

    <function name= "keronic:ls-mof-phase-ls-cable-l2-indication" as="xs:string*">
        <sequence select="$config_file/config/LSmof/LSkabelPhaseCheck/L2"/>
    </function>

    <function name= "keronic:ls-mof-phase-ls-cable-l3-indication" as="xs:string*">
        <sequence select="$config_file/config/LSmof/LSkabelPhaseCheck/L3"/>
    </function>

    <function name= "keronic:ls-mof-phase-ls-cable-f3-indication" as="xs:string*">
        <sequence select="$config_file/config/LSmof/LSkabelPhaseCheck/F3"/>
    </function>

    <function name= "keronic:ls-mof-phase-ls-cable-required-count" as="xs:string">
        <sequence select="$config_file/config/LSmof/LSkabelPhaseCheck/RequiredCount"/>
    </function>

    <function name= "keronic:ls-mof-new-ls-cable-count" as="xs:string">
        <value-of select="$config_file/config/LSmof/LSkabelSpanningCheck/RequiredCount"/>
    </function>

    <function name= "keronic:e-aarddraad-connected-buildings-count" as="xs:string">
        <value-of select="$config_file/config/EAarddraad/ConnectedBuildingsCount"/>
    </function>

    <function name= "keronic:ls-cable-get-max-depth" as="xs:string">
        <value-of select="$config_file/config/LSkabel/MaxDepth"/>
    </function>

    <function name= "keronic:ls-cable-get-min-depth" as="xs:string">
        <value-of select="$config_file/config/LSkabel/MinDepth"/>
    </function>

    <function name="keronic:get-connected-maaiveld-threshold" as="xs:string">
        <value-of select="$config_file/config/Topology/ConnectedMaaiveldThreshold"/>
    </function>
